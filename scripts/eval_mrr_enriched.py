"""
MRR Evaluation: Enriched Dataset Only
"""
...
for model_name, model_path in MODELS.items():
    all_results.append(evaluate_dataset_model(df_enriched, model_name, model_path, "Enriched"))

pd.DataFrame(all_results).to_csv('results_enriched.csv', index=False)
print("Saved: results_enriched.csv")
